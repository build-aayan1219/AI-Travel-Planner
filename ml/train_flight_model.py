# ============================================================
#  ml/train_flight_model.py
#  Trains flight price predictor on flight_prices.csv
#
#  HOW TO RUN:
...
print("=" * 50)
print("  Flight Price Predictor — Model Training")
print("=" * 50)
...
try:
    ...
    print("   Make sure flight_prices.csv is in your data/ folder.")
    exit()
